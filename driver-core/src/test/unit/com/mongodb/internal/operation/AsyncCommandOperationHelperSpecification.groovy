...
class AsyncCommandOperationHelperSpecification extends Specification {
    ...
    def 'should retry with retryable exception'() {
        ...
        when:
        executeRetryableCommandAsync(asyncWriteBinding, dbName, primary(), new NoOpFieldNameValidator(), decoder,
    ...
    def 'should set read preference to primary when using AsyncWriteBinding'() {
        ...
        when:
        executeCommandAsync(asyncWriteBinding, dbName, command, connection, function, callback)

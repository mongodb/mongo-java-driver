...
class LegacyMixedBulkWriteOperationSpecification extends OperationFunctionalSpecification {
    ...
    def 'should throw IllegalArgumentException for empty list of requests'() {
        when:
        new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, true, [])
    ...
    def 'should return correct result for insert'() {
        ...
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, false, inserts)
    ...
    def 'should insert a single document'() {
        ...
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, false, asList(insert))
    ...
    def 'should execute unacknowledged write'() {
        ...
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), true, UNACKNOWLEDGED, false,
    ...
    def 'should continue on error when continuing on error'() {
        ...
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), false, ACKNOWLEDGED, false, documents)
    ...
    def 'should not continue on error when not continuing on error'() {
        ...
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, false, documents)
    ...
    def 'should support retryable writes'() {
        given:
        def insert = new InsertRequest(new BsonDocument('_id', new BsonInt32(1)))
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, true, asList(insert))
    ...
    def 'should remove a document'() {
        ...
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, false,
    ...
    def 'should return correct result for replace'() {
        ...
        def operation = new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, false, asList(replacement))
    ...
    def 'should replace a single document'() {
        given:
        def insert = new InsertRequest(new BsonDocument('_id', new BsonInt32(1)))
        new LegacyMixedBulkWriteOperation(getNamespace(), true, ACKNOWLEDGED, false, asList(insert)).execute(getBinding())

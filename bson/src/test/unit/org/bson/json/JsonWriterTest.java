...
public class JsonWriterTest {
    ...
    public void testDouble() {
        List<TestData<Double>> tests = asList(new TestData<>(0.0, "0.0"), new TestData<>(0.0005, "5.0E-4"),
                ...
                new TestData<>(1.5, "1.5"), new TestData<>(1.5E40, "1.5E+40"),
                new TestData<>(1.5E-40, "1.5E-40"),
                new TestData<>(1234567890.1234568E+123, "1.2345678901234568E+132"),
                new TestData<>(Double.MAX_VALUE, "1.7976931348623157E+308"),

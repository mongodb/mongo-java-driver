...
class ListCollectionsOperationSpecification extends OperationFunctionalSpecification {
    ...
    def 'should return empty set if database does not exist'() {
        given:
        def operation = new ListCollectionsOperation(CSOT_TIMEOUT, madeUpDatabase, new DocumentCodec())
    ...
    def 'should return collection names if a collection exists'() {
        given:
        def operation = new ListCollectionsOperation(CSOT_TIMEOUT, databaseName, new DocumentCodec())
    ...
    def 'should filter indexes when calling hasNext before next'() {
        ...
        addSeveralIndexes()
        def operation = new ListCollectionsOperation(CSOT_TIMEOUT, databaseName, new DocumentCodec()).batchSize(2)
    ...
    def 'should use the ReadBindings readPreference to set slaveOK'() {
        ...
        def operation = new ListCollectionsOperation(CSOT_TIMEOUT, helper.dbName, helper.decoder)

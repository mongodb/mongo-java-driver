...
public class PropertyFieldOnlyModel {

    public String publicProperty;
    String protectedProperty;
    private String privateProperty;

    public PropertyFieldOnlyModel(){
    }

    public PropertyFieldOnlyModel(final String publicProperty, final String protectedProperty, final String privateProperty) {
    ...
    public boolean equals(final Object o) {
        ...
        final PropertyFieldOnlyModel that = (PropertyFieldOnlyModel) o;

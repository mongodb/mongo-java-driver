...
public interface AsyncMongoDatabase {
     ...
     */
    AsyncMongoCollection<Document> getCollection(String collectionName);
     ...
     * @return the collection
     */
    <TDocument> AsyncMongoCollection<TDocument> getCollection(String collectionName, Class<TDocument> documentClass);
     ...
     */
    void runCommand(AsyncClientSession clientSession, Bson command, SingleResultCallback<Document> callback);
     ...
     * @mongodb.server.release 3.6
     */
    void runCommand(AsyncClientSession clientSession, Bson command, ReadPreference readPreference, SingleResultCallback<Document> callback);
    /**
     * Executes the given command in the context of the current database with a read preference of {@link ReadPreference#primary()}.
     *
     * @param clientSession  the client session with which to associate this operation
     ...
     * @mongodb.server.release 3.6
     */
    <TResult> void runCommand(AsyncClientSession clientSession, Bson command, Class<TResult> resultClass,
                              SingleResultCallback<TResult> callback);
     ...
     * @mongodb.server.release 3.6
     */
    <TResult> void runCommand(AsyncClientSession clientSession, Bson command, ReadPreference readPreference, Class<TResult> resultClass,
                              SingleResultCallback<TResult> callback);
     ...
     * @mongodb.server.release 3.6
     */
    AsyncMongoIterable<String> listCollectionNames(AsyncClientSession clientSession);
     ...
     * @mongodb.driver.manual reference/command/listCollections listCollections
     */
    <TResult> AsyncListCollectionsIterable<TResult> listCollections(Class<TResult> resultClass);
     ...
     * @mongodb.server.release 3.6
     */
    AsyncListCollectionsIterable<Document> listCollections(AsyncClientSession clientSession);
     ...
     * @mongodb.server.release 3.6
     */
    <TResult> AsyncListCollectionsIterable<TResult> listCollections(AsyncClientSession clientSession, Class<TResult> resultClass);
     ...
     * @mongodb.server.release 3.6
     */
    void createCollection(AsyncClientSession clientSession, String collectionName, SingleResultCallback<Void> callback);
     ...
     * @mongodb.server.release 3.6
     */
    void createCollection(AsyncClientSession clientSession, String collectionName, CreateCollectionOptions options,
     ...
     * @mongodb.server.release 3.6
     */
    void createView(AsyncClientSession clientSession, String viewName, String viewOn, List<? extends Bson> pipeline,
                    SingleResultCallback<Void> callback);
     ...
     * @mongodb.server.release 3.6
     */
    AsyncAggregateIterable<Document> aggregate(List<? extends Bson> pipeline);
     ...
     * @mongodb.server.release 3.6
     */
    AsyncAggregateIterable<Document> aggregate(AsyncClientSession clientSession, List<? extends Bson> pipeline);

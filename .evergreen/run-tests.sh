...
echo "Compiling java driver with jdk6"
...
JAVA_HOME="/opt/java/${JDK}"
./gradlew -version
./gradlew -Dorg.mongodb.test.uri=${MONGODB_URI} ${GRADLE_EXTRA_VARS} --stacktrace --info -x classes -x testClasses --rerun-tasks test

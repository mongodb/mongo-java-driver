...
class AsyncDistinctIterableSpecification extends Specification {
    ...
    def 'should build the expected DistinctOperation'() {
        ...
        def distinctIterable = new AsyncDistinctIterableImpl(null, namespace, Document, Document, codecRegistry, readPreference,
    ...
    def 'should handle exceptions correctly'() {
        ...
        def distinctIterable = new AsyncDistinctIterableImpl(null, namespace, Document, BsonDocument, codecRegistry, readPreference,
                readConcern, executor, 'field', new BsonDocument(), true)
    ...
    def 'should follow the MongoIterable interface as expected'() {
        ...
        def mongoIterable = new AsyncDistinctIterableImpl(null, namespace, Document, Document, codecRegistry, readPreference, readConcern,
    ...
    def 'should check variables using notNull'() {
        given:
        def mongoIterable = new AsyncDistinctIterableImpl(null, namespace, Document, Document, codecRegistry, readPreference,

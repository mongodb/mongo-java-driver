...
final class AsyncGridFSDownloadStreamImpl implements AsyncGridFSDownloadStream {
    ...
    AsyncGridFSDownloadStreamImpl(@Nullable final AsyncClientSession clientSession, final AsyncGridFSFindIterable fileInfoIterable,
    ...
    @Override
    public AsyncGridFSDownloadStream batchSize(final int batchSize) {

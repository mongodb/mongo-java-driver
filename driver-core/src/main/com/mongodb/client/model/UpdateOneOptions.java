...
/**
 * The options for updating at most one document that matches the query criteria.
 *
 * @since 3.0
 ...
 */
public final class UpdateOneOptions {
     ...
     * @return this
     */
    public UpdateOneOptions upsert(final boolean upsert) {
        this.upsert = upsert;
        return this;
    }
}

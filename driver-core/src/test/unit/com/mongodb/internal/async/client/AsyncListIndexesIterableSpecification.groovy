...
class AsyncListIndexesIterableSpecification extends Specification {
    ...
    def 'should build the expected listIndexesOperation'() {
        ...
        def listIndexesIterable = new AsyncListIndexesIterableImpl<Document>(null, namespace, Document, codecRegistry, readPreference,
                executor, true)
    ...
    def 'should follow the MongoIterable interface as expected'() {
        ...
        def mongoIterable = new AsyncListIndexesIterableImpl<Document>(null, namespace, Document, codecRegistry, readPreference,
                executor, true)

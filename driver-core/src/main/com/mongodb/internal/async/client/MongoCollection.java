...
public interface MongoCollection<TDocument> {
     ...
     * @mongodb.driver.manual reference/command/update   Update Command Behaviors
     * @see MongoCollection#replaceOne(Bson, Object, SingleResultCallback)
     */
     ...
     * @mongodb.driver.manual reference/operator/update/ Update Operators
     * @mongodb.driver.manual reference/command/update   Update Command Behaviors
     * @see MongoCollection#replaceOne(Bson, Object, ReplaceOptions, SingleResultCallback)
     */
     ...
     * @since 3.6
     * @mongodb.server.release 3.6
     * @see MongoCollection#replaceOne(ClientSession, Bson, Object, SingleResultCallback)
     */
     ...
     * <p>Use this method to only update the corresponding fields in the document according to the update operators used in the update
     * document. To replace the entire document with a new document, use the corresponding {@link #replaceOne(ClientSession, Bson, Object,
     * ReplaceOptions, SingleResultCallback)} method.</p>
     *
     * <p>Note: Supports retryable writes on MongoDB server versions 3.6 or higher when the retryWrites setting is enabled.</p>
     * @param clientSession  the client session with which to associate this operation
     * @param filter   a document describing the query filter, which may not be null.
     ...
     * @since 3.6
     * @mongodb.server.release 3.6
     * @see MongoCollection#replaceOne(ClientSession, Bson, Object, ReplaceOptions, SingleResultCallback)
     */
     ...
     * @mongodb.driver.manual reference/command/update   Update Command Behaviors
     * @see MongoCollection#findOneAndReplace(Bson, Object, SingleResultCallback)
     */
     ...
     * @mongodb.driver.manual reference/command/update   Update Command Behaviors
     * @see MongoCollection#findOneAndReplace(Bson, Object, FindOneAndReplaceOptions, SingleResultCallback)
     */
     ...
     * @since 3.6
     * @mongodb.server.release 3.6
     * @see MongoCollection#findOneAndReplace(ClientSession, Bson, Object, SingleResultCallback)
     */

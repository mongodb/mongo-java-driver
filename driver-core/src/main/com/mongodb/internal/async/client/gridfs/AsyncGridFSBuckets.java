...
public final class AsyncGridFSBuckets {
     ...
     */
    public static AsyncGridFSBucket create(final AsyncMongoDatabase database) {
        return new AsyncGridFSBucketImpl(database);
    }
     ...
     * @return the GridFSBucket
     */
    public static AsyncGridFSBucket create(final AsyncMongoDatabase database, final String bucketName) {
        return new AsyncGridFSBucketImpl(database, bucketName);
    }

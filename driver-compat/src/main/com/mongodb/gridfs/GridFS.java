 ...
 * parts, or chunks, and stores each of those chunks as a separate document. By
 ...
 * sections of files, which allows you to "skip" into the middle of a video or
 * audio file.
 * <p/>
 * GridFS is useful not only for storing files that exceed 16MB but also for
 * storing any files for which you want access without having to load the entire
 * file into memory. For more information on the indications of GridFS, see
...
public class GridFS {
    ...
    /**
     * Finds one file matching the given objectId. Equivalent to
     * findOne(objectId).
     * 
     * @param objectId
    ...
    /**
     * Creates a file entry. After calling this method, you have to call save to
     * persist the file object.
     * 
     * @param data
     *            the file's data
    ...
    /**
     * Gets the bucket name used in the collection's namespace. Default value is
     * 'fs'.
     * 

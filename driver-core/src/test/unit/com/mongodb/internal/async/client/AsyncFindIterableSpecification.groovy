...
class AsyncFindIterableSpecification extends Specification {
    ...
    def 'should build the expected findOperation'() {
        ...
        def findIterable = new AsyncFindIterableImpl(null, namespace, Document, Document, codecRegistry, readPreference, readConcern,
        ...
        new AsyncFindIterableImpl(null, namespace, Document, Document, codecRegistry, readPreference, readConcern, executor,
                new Document('filter', 1), true)
                .filter(null as Bson)
                .collation(null)
                .projection(null)
                .sort(null as Bson)
    ...
    def 'should follow the MongoIterable interface as expected'() {
        ...
        def mongoIterable = new AsyncFindIterableImpl(null, new MongoNamespace('db', 'coll'), Document, Document, codecRegistry,
    ...
    def 'should check variables using notNull'() {
        given:
        def mongoIterable = new AsyncFindIterableImpl(null, namespace, Document, Document, codecRegistry, readPreference,
                readConcern, Stub(OperationExecutor), new Document(), true)

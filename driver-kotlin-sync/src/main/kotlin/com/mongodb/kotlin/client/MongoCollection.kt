...
public class MongoCollection<T : Any>(private val wrapped: JMongoCollection<T>) {
    ...
    public fun mapReduce(mapFunction: String, reduceFunction: String): MapReduceIterable<T> =
    ...
    public fun mapReduce(
        clientSession: ClientSession,
        mapFunction: String,
        reduceFunction: String
    ): MapReduceIterable<T> = mapReduce(clientSession, mapFunction, reduceFunction, documentClass)
    ...
    public fun <R : Any> mapReduce(
        ...
        reduceFunction: String,
        resultClass: Class<R>
    ): MapReduceIterable<R> = MapReduceIterable(wrapped.mapReduce(mapFunction, reduceFunction, resultClass))
    ...
    @Suppress("DEPRECATION")
    @Deprecated("Map Reduce has been deprecated. Use Aggregation instead", replaceWith = ReplaceWith(""))
    public inline fun <reified R : Any> mapReduce(mapFunction: String, reduceFunction: String): MapReduceIterable<R> =
    ...
    public inline fun <reified R : Any> mapReduce(
        ...
        mapFunction: String,
        reduceFunction: String
    ): MapReduceIterable<R> = mapReduce(clientSession, mapFunction, reduceFunction, R::class.java)

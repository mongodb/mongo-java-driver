 ...
 * connection to a KMS host. Prose test 28 asserts this by observing a {@code kmsConnectCallback}; since this driver
 * provides proxy support declaratively rather than through a callback, there is no callback to observe, so the
 * requirement is verified here instead.
 */
final class KeyManagementServiceTest {
    ...
    private final KeyManagementService keyManagementService =
            new KeyManagementService(emptyMap(), ProxySettings.builder().build(), CONNECT_TIMEOUT_MILLIS);

...
class MapReduceToCollectionOperationSpecification extends OperationFunctionalSpecification {
    ...
    def mapReduceOperation = new MapReduceToCollectionOperation(CSOT_TIMEOUT, mapReduceInputNamespace,
    ...
    def cleanup() {
        new DropCollectionOperation(CSOT_TIMEOUT, mapReduceInputNamespace).execute(getBinding())
        new DropCollectionOperation(CSOT_TIMEOUT, mapReduceOutputNamespace).execute(getBinding())
    }
    ...
    def 'should have the correct defaults'() {
        ...
        when:
        def operation =  new MapReduceToCollectionOperation(CSOT_TIMEOUT, getNamespace(), mapF, reduceF, out)
    ...
    def 'should set optional values correctly'(){
        ...
        when:
        def operation =  new MapReduceToCollectionOperation(CSOT_TIMEOUT, getNamespace(), mapF, reduceF, out, writeConcern)
                .action(action)
                .databaseName(dbName)
    ...
    def 'should support bypassDocumentValidation'() {
        ...
        when:
        def operation = new MapReduceToCollectionOperation(CSOT_TIMEOUT, mapReduceInputNamespace,
    ...
    def 'should create the expected command'() {
        ...
        when:
        def operation =  new MapReduceToCollectionOperation(CSOT_MAX_TIME, getNamespace(), mapF, reduceF, out,

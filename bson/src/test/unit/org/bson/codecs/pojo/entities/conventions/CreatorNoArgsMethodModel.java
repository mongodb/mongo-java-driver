...
public final class CreatorNoArgsMethodModel {
    ...
    private CreatorNoArgsMethodModel() {
    }

    public CreatorNoArgsMethodModel(final Integer integerField, final String stringField, final long longField) {
    ...
    public String toString() {
        return "CreatorNoArgsMethodModel{"

...
class AsyncListDatabasesIterableSpecification extends Specification {
    ...
    def 'should follow the MongoIterable interface as expected'() {
        ...
        def mongoIterable = new AsyncListDatabasesIterableImpl<Document>(null, Document, codecRegistry, readPreference, executor, true)
    ...
    def 'should check variables using notNull'() {
        given:
        def mongoIterable = new AsyncListDatabasesIterableImpl<Document>(null, Document, codecRegistry, readPreference,

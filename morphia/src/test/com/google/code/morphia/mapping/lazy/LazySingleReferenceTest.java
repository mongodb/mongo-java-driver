...
public class LazySingleReferenceTest extends ProxyTestBase {
	...
	public final void testCreateProxy() {
		...
		LazySingleReferenceReferencedEntity referenced = new LazySingleReferenceReferencedEntity();
	...
	public final void testShortcutInterface() {
        ...
        LazySingleReferenceRootEntity root = new LazySingleReferenceRootEntity();
		LazySingleReferenceReferencedEntity reference = new LazySingleReferenceReferencedEntity();
		
		root.r = reference;
		reference.setFoo("bar");
		
		Key<LazySingleReferenceReferencedEntity> k = ds.save(reference);
	...
	public final void testSerialization() {
		...
		LazySingleReferenceReferencedEntity e2 = new LazySingleReferenceReferencedEntity();
	...
	public static class LazySingleReferenceRootEntity extends TestEntity implements Serializable {
		...
		@Reference(lazy = true)
        LazySingleReferenceReferencedEntity r;
		@Reference(lazy = true)
        LazySingleReferenceReferencedEntity secondReference;

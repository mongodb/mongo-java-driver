...
abstract class AsyncMongoIterableImpl<TResult> implements AsyncMongoIterable<TResult> {
    ...
    AsyncMongoIterableImpl(@Nullable final AsyncClientSession clientSession, final OperationExecutor executor,
    ...
    @Override
    public <U> AsyncMongoIterable<U> map(final Function<TResult, U> mapper) {
        return new MappingIterable<TResult, U>(this, mapper);
    }

    @Override
    public AsyncMongoIterable<TResult> batchSize(final int batchSize) {

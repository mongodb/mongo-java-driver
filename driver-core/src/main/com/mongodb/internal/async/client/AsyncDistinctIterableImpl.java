...
class AsyncDistinctIterableImpl<TDocument, TResult> extends AsyncMongoIterableImpl<TResult> implements AsyncDistinctIterable<TResult> {
    ...
    @Override
    public AsyncDistinctIterable<TResult> filter(@Nullable final Bson filter) {
        this.filter = filter;
        return this;
    }

    @Override
    public AsyncDistinctIterable<TResult> maxTime(final long maxTime, final TimeUnit timeUnit) {
    ...
    @Override
    public AsyncDistinctIterable<TResult> batchSize(final int batchSize) {
        super.batchSize(batchSize);
        return this;
    }

    @Override
    public AsyncDistinctIterable<TResult> collation(@Nullable final Collation collation) {

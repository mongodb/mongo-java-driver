...
public class CodeSerializer implements Serializer<Code> {
    ...
    @Override
    public void serialize(final BSONWriter bsonWriter, final Code value) {
        bsonWriter.writeJavaScript(value.getCode());
    }

    @Override
    public Code deserialize(final BSONReader bsonReader) {
        return new Code(bsonReader.readJavaScript());
    }

    @Override
    public Class<Code> getSerializationClass() {
        return Code.class;
    }
}

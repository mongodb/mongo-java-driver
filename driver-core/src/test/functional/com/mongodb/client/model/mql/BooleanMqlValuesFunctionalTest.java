...
class BooleanMqlValuesFunctionalTest extends AbstractMqlValuesFunctionalTest {
    ...
    private final MqlBoolean tru = MqlValues.of(true);
    private final MqlBoolean fal = MqlValues.of(false);
    ...
    public void condTest() {
        ...
        MqlString abc = MqlValues.of("abc");
        MqlString xyz = MqlValues.of("xyz");
        MqlNumber nnn = MqlValues.of(123);
        assertExpression(
                true && false ? "abc" : "xyz",

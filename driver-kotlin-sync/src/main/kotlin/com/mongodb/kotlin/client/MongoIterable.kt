 ...
 */
public open class MongoIterable<T>(@PublishedApi internal val delegate: JMongoIterable<T>) {
     ...
     */
    public fun <R> map(transform: (T) -> R & Any): MongoIterable<R> = MongoIterable(delegate.map(transform))

...
/**
 * Permanently drops a stream processor.
 *
 * <p>This class is not part of the public API and may be removed or changed at any time</p>
 */
public final class DropStreamProcessorOperation implements WriteOperation<Void> {
    private static final String COMMAND_NAME = "dropStreamProcessor";
    private static final String DATABASE = "admin";

    private final String processorName;

    public DropStreamProcessorOperation(final String processorName) {

...
public class InterfaceWithDefaultMethodModelImpl extends InterfaceModelAbstract implements InterfaceModelC {

    private String propertyC;

    public InterfaceWithDefaultMethodModelImpl() {
    }

    public InterfaceWithDefaultMethodModelImpl(final String propertyA, final String propertyC) {
        super(propertyA);
    ...
    public boolean equals(final Object o) {
        ...
        InterfaceWithDefaultMethodModelImpl that = (InterfaceWithDefaultMethodModelImpl) o;

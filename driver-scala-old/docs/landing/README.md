# MongoDB Scala Driver Front page

The static front page site for the Scala documentation portal.
...
| --baseUrl=http://localhost/ | Normally the base url will be /mongo-scala-driver for gh-pages           |
...
Existing versions live in `static/versions.json`

...
public class MongoClientURI {
        ...
        for (String _part : optionsPart.split("&|;")) {
            ...
            if (idx >= 0) {
                ...
                if (key.equals("maxpoolsize")) {
                    ...
                    Document tagSet = getTagSet(value.trim());
                    if (firstTagSet == null) {
                        firstTagSet = tagSet;
                    } else {
    ...
    private void buildReadPreference(final MongoClientOptions.Builder builder, final String readPreferenceType,
                                     final Document firstTagSet, final List<Document> remainingTagSets, final Boolean slaveOk) {
    ...
    private Document getTagSet(String tagSetString) {

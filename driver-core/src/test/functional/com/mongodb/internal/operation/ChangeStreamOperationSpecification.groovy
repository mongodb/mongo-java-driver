...
class ChangeStreamOperationSpecification extends OperationFunctionalSpecification {
    ...
    def 'should have the correct defaults'() {
        when:
        ChangeStreamOperation operation = new ChangeStreamOperation<Document>(CSOT_TIMEOUT, getNamespace(), FullDocument.DEFAULT,
                [], new DocumentCodec())
    ...
    def 'should set optional values correctly'() {
        when:
        ChangeStreamOperation operation = new ChangeStreamOperation<Document>(CSOT_TIMEOUT, getNamespace(),
    ...
    def 'should create the expected command'() {
        ...
        def operation = new ChangeStreamOperation<Document>(CSOT_NO_TIMEOUT, namespace, FullDocument.DEFAULT, pipeline,
    ...
    def 'should decode insert to ChangeStreamDocument '() {
        ...
        def pipeline = [BsonDocument.parse('{$match: {operationType: "insert"}}')]
        def operation = new ChangeStreamOperation<BsonDocument>(CSOT_TIMEOUT, helper.getNamespace(), FullDocument.DEFAULT, pipeline,
    ...
    def 'should decode update to ChangeStreamDocument '() {
        ...
        def operation = new ChangeStreamOperation<BsonDocument>(CSOT_TIMEOUT, helper.getNamespace(), FullDocument.UPDATE_LOOKUP,
    ...
    def 'should decode rename to ChangeStreamDocument '() {
        ...
        def operation = new ChangeStreamOperation<ChangeStreamDocument>(CSOT_TIMEOUT, helper.getNamespace(),
    ...
    def 'should set the startAtOperationTime on the sync cursor'() {
        ...
        new ChangeStreamOperation<BsonDocument>(CSOT_TIMEOUT, helper.getNamespace(), FullDocument.DEFAULT, [], CODEC)

...
public class CodecsArrayEncodingTest {
    //CHECKSTYLE:OFF
    @Rule
    ...
    public void setUp() {
        ...
        codecs = new Codecs(primitiveCodecs);
    }
    ...
    public void shouldEncodeArrayOfInts() {
        ...
        codecs.encode(bsonWriter, arrayOfInts);
    }
    ...
    public void shouldEncodeArrayOfLongs() {
        ...
        codecs.encode(bsonWriter, array);
    }
    ...
    @Test
    public void shouldDelegateEncodingOfStringToCodecs() {
        ...
        codecs.encode(bsonWriter, arrayOfStrings);
    }

    @Test
    @Ignore("Can't test this now")
    public void shouldUnwrapMultiDimensionalArrayAndDelegateSubArraysToCodecs() {
        final int[][] multiDimensionalArray = {{1}, {2}, {3}};
        context.checking(new Expectations() {{
            oneOf(bsonWriter).writeStartArray();
//            oneOf(codecs).encode(bsonWriter, new int[]{1});
//            oneOf(codecs).encode(bsonWriter, new int[]{2});
//            oneOf(codecs).encode(bsonWriter, new int[]{3});
            oneOf(bsonWriter).writeEndArray();
        }});

        codecs.encode(bsonWriter, multiDimensionalArray);
    }

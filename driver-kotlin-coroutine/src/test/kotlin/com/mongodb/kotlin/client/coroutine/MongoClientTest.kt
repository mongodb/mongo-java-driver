...
class MongoClientTest {
    ...
    fun shoulCallTheUnderlyingStartSession() {
        ...
        whenever(wrapped.startSession(refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.startSession(options)).doReturn(Mono.fromCallable { mock() })

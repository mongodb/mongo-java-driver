...
{{< install artifactId="mongodb-driver-sync" version="4.3.0-beta1" dependencies="true">}}
...
{{< install artifactId="mongodb-driver-legacy" version="4.3.0-beta1" dependencies="true">}}

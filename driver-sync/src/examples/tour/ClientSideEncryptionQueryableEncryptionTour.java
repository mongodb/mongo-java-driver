...
public class ClientSideEncryptionQueryableEncryptionTour {
    ...
    public static void main(final String[] args) {
        ...
        mongoClient.getDatabase("keyvault").getCollection("datakeys").drop();
        mongoClient.getDatabase("docsExamples").drop();
        ...
        docsExamplesDatabase.createCollection("encrypted");
        ...
        BsonDocument findResult = encryptedCollection.find(Filters.eq("encryptedIndexed", "indexedValue")).first();
        ...
        findResult = unencryptedCollection.find(Filters.eq("_id", 1)).first();
        assert findResult != null;

...
class ProxySettingsTest {
    static Stream<Arguments> shouldThrowExceptionWhenProxySettingAreInInvalid() {
        return Stream.of(
    ...
    @ParameterizedTest
    @MethodSource
    void shouldThrowExceptionWhenProxySettingAreInInvalid(final ProxySettings.Builder builder, final String expectedErrorMessage) {

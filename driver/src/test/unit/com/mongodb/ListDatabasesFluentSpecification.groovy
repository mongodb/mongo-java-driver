...
class ListDatabasesFluentSpecification extends Specification {
    ...
    def 'should build the expected listCollectionOperation'() {
        ...
        def listDatabaseFluent = new ListDatabasesFluentImpl<Document>(Document, codecRegistry, readPreference, executor)
                .maxTime(1000, MILLISECONDS)

        when: 'default input should be as expected'
        listDatabaseFluent.iterator()
        ...
        listDatabaseFluent.maxTime(999, MILLISECONDS).iterator()

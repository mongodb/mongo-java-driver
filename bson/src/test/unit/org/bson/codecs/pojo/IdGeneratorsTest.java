...
public class IdGeneratorsTest {
    ...
    public void testObjectIdGenerator() {
        IdGenerator<ObjectId> idGenerator = IdGenerators.OBJECT_ID_GENERATOR;

        assertEquals(ObjectId.class, idGenerator.getType());
        assertEquals(ObjectId.class, idGenerator.generate().getClass());
    }

    @Test
    public void testBsonObjectIdGenerator() {
        IdGenerator<BsonObjectId> idGenerator = IdGenerators.BSON_OBJECT_ID_GENERATOR;

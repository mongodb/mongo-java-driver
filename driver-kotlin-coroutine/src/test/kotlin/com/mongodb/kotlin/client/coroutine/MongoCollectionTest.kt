...
class MongoCollectionTest {
    ...
    fun shouldCallTheUnderlyingCountDocuments() {
        ...
        whenever(wrapped.countDocuments(eq(defaultFilter), refEq(defaultOptions))).doReturn(Mono.fromCallable { 1 })
        whenever(wrapped.countDocuments(eq(filter), refEq(defaultOptions))).doReturn(Mono.fromCallable { 2 })
        whenever(wrapped.countDocuments(eq(filter), eq(options))).doReturn(Mono.fromCallable { 3 })
        whenever(wrapped.countDocuments(eq(clientSession.wrapped), eq(defaultFilter), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { 4 })
        whenever(wrapped.countDocuments(eq(clientSession.wrapped), eq(filter), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { 5 })
        whenever(wrapped.countDocuments(eq(clientSession.wrapped), eq(filter), eq(options)))
            .doReturn(Mono.fromCallable { 6 })
    ...
    fun shouldCallTheUnderlyingEstimatedDocumentCount() {
        ...
        whenever(wrapped.estimatedDocumentCount(refEq(defaultOptions))).doReturn(Mono.fromCallable { 1 })
        whenever(wrapped.estimatedDocumentCount(options)).doReturn(Mono.fromCallable { 2 })
    ...
    fun shouldCallTheUnderlyingInsertOne() {
        ...
        whenever(wrapped.insertOne(eq(value), refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.insertOne(eq(value), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.insertOne(eq(clientSession.wrapped), eq(value), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.insertOne(eq(clientSession.wrapped), eq(value), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingInsertMany() {
        ...
        whenever(wrapped.insertMany(eq(value), refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.insertMany(eq(value), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.insertMany(eq(clientSession.wrapped), eq(value), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.insertMany(eq(clientSession.wrapped), eq(value), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingBulkWrite() {
        ...
        whenever(wrapped.bulkWrite(eq(value), refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.bulkWrite(eq(value), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.bulkWrite(eq(clientSession.wrapped), eq(value), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.bulkWrite(eq(clientSession.wrapped), eq(value), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingUpdateOne() {
        ...
        whenever(wrapped.updateOne(eq(filter), eq(update), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateOne(eq(filter), eq(update), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateOne(eq(filter), eq(updates), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateOne(eq(filter), eq(updates), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateOne(eq(clientSession.wrapped), eq(filter), eq(update), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateOne(eq(clientSession.wrapped), eq(filter), eq(update), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateOne(eq(clientSession.wrapped), eq(filter), eq(updates), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateOne(eq(clientSession.wrapped), eq(filter), eq(updates), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingUpdateMany() {
        ...
        whenever(wrapped.updateMany(eq(filter), eq(update), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateMany(eq(filter), eq(update), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateMany(eq(filter), eq(updates), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateMany(eq(filter), eq(updates), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateMany(eq(clientSession.wrapped), eq(filter), eq(update), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateMany(eq(clientSession.wrapped), eq(filter), eq(update), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateMany(eq(clientSession.wrapped), eq(filter), eq(updates), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.updateMany(eq(clientSession.wrapped), eq(filter), eq(updates), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingReplaceOne() {
        ...
        whenever(wrapped.replaceOne(eq(filter), eq(replacement), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.replaceOne(eq(filter), eq(replacement), eq(options))).doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingDeleteOne() {
        ...
        whenever(wrapped.deleteOne(eq(filter), refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.deleteOne(eq(filter), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.deleteOne(eq(clientSession.wrapped), eq(filter), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.deleteOne(eq(clientSession.wrapped), eq(filter), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingDeleteMany() {
        ...
        whenever(wrapped.deleteMany(eq(filter), refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.deleteMany(eq(filter), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.deleteMany(eq(clientSession.wrapped), eq(filter), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.deleteMany(eq(clientSession.wrapped), eq(filter), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingFindOneAndDelete() {
        ...
        whenever(wrapped.findOneAndDelete(eq(filter), refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.findOneAndDelete(eq(filter), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.findOneAndDelete(eq(clientSession.wrapped), eq(filter), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.findOneAndDelete(eq(clientSession.wrapped), eq(filter), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingFindOneAndUpdate() {
        ...
        whenever(wrapped.findOneAndUpdate(eq(filter), eq(update), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.findOneAndUpdate(eq(filter), eq(update), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.findOneAndUpdate(eq(filter), eq(updateList), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.findOneAndUpdate(eq(filter), eq(updateList), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
    ...
    fun shouldCallTheUnderlyingFindOneAndReplace() {
        ...
        whenever(wrapped.findOneAndReplace(eq(filter), eq(replacement), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.findOneAndReplace(eq(filter), eq(replacement), eq(options)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(
    ...
    fun shouldCallTheUnderlyingDrop() {
        ...
        whenever(wrapped.drop(refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.drop(options)).doReturn(Mono.empty())
        whenever(wrapped.drop(eq(clientSession.wrapped), refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.drop(clientSession.wrapped, options)).doReturn(Mono.empty())
    ...
    fun shouldCallTheUnderlyingCreateIndex() {
        ...
        whenever(wrapped.createIndex(eq(key), refEq(defaultOptions))).doReturn(Mono.fromCallable { "1" })
        whenever(wrapped.createIndex(eq(key), eq(options))).doReturn(Mono.fromCallable { "2" })
        whenever(wrapped.createIndex(eq(clientSession.wrapped), eq(key), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { "3" })
        whenever(wrapped.createIndex(eq(clientSession.wrapped), eq(key), eq(options)))
            .doReturn(Mono.fromCallable { "4" })
    ...
    fun shouldCallTheUnderlyingCreateIndexes() {
        ...
        whenever(wrapped.createIndexes(eq(indexes), refEq(defaultOptions))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.createIndexes(eq(indexes), eq(options))).doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.createIndexes(eq(clientSession.wrapped), eq(indexes), refEq(defaultOptions)))
            .doReturn(Mono.fromCallable { mock() })
        whenever(wrapped.createIndexes(eq(clientSession.wrapped), eq(indexes), eq(options)))
            .doReturn(Mono.fromCallable { mock() })

        runBlocking {
            mongoCollection.createIndexes(indexes)
            mongoCollection.createIndexes(indexes, options)
            mongoCollection.createIndexes(clientSession, indexes)
            mongoCollection.createIndexes(clientSession, indexes, options)
        }
    ...
    fun shouldCallTheUnderlyingDropIndex() {
        ...
        whenever(wrapped.dropIndex(eq(indexName), refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.dropIndex(eq(indexName), eq(options))).doReturn(Mono.empty())
        whenever(wrapped.dropIndex(eq(keys), refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.dropIndex(eq(keys), eq(options))).doReturn(Mono.empty())
        whenever(wrapped.dropIndex(eq(clientSession.wrapped), eq(indexName), refEq(defaultOptions)))
            .doReturn(Mono.empty())
        whenever(wrapped.dropIndex(eq(clientSession.wrapped), eq(indexName), eq(options))).doReturn(Mono.empty())
        whenever(wrapped.dropIndex(eq(clientSession.wrapped), eq(keys), refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.dropIndex(eq(clientSession.wrapped), eq(keys), eq(options))).doReturn(Mono.empty())
    ...
    fun shouldCallTheUnderlyingDropIndexes() {
        ...
        whenever(wrapped.dropIndexes(refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.dropIndexes(options)).doReturn(Mono.empty())
        whenever(wrapped.dropIndexes(eq(clientSession.wrapped), refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.dropIndexes(clientSession.wrapped, options)).doReturn(Mono.empty())
    ...
    fun shouldCallTheUnderlyingRenameCollection() {
        ...
        whenever(wrapped.renameCollection(eq(mongoNamespace), refEq(defaultOptions))).doReturn(Mono.empty())
        whenever(wrapped.renameCollection(eq(mongoNamespace), eq(options))).doReturn(Mono.empty())
        whenever(wrapped.renameCollection(eq(clientSession.wrapped), eq(mongoNamespace), refEq(defaultOptions)))
            .doReturn(Mono.empty())
        whenever(wrapped.renameCollection(eq(clientSession.wrapped), eq(mongoNamespace), eq(options)))
            .doReturn(Mono.empty())

...
public class GeoJsonPoint extends GeoJsonObject<GeoJsonCoordinates> {
    private static final long serialVersionUID = 3290666966734571626L;

    {
        this.setType(GeoJsonObject.POINT);
    }

    public GeoJsonPoint(final GeoJsonCoordinates coordinates) {

...
public class IdHoldingBsonWriter extends LevelCountingBsonWriter {
    ...
    public void writeEndDocument() {
        if (isWritingId()) {
            if (getIdBsonWriterCurrentLevel() > INITIAL_LEVEL) {
        ...
        if (getCurrentLevel() == INITIAL_LEVEL + 1 && id == null) {
    ...
    public void writeEndArray() {
        if (isWritingId()) {
            ...
            if (getIdBsonWriterCurrentLevel() == INITIAL_LEVEL + 1 && idFieldIsAnArray) {
                getIdBsonWriter().writeEndDocument();
    ...
    private boolean isWritingId() {
        return getIdBsonWriterCurrentLevel() > INITIAL_LEVEL || (getCurrentLevel() == INITIAL_LEVEL + 1 && currentFieldName != null
    ...
    private int getIdBsonWriterCurrentLevel() {
        return idBsonBinaryWriter == null ? INITIAL_LEVEL : idBsonBinaryWriter.getCurrentLevel();
    }

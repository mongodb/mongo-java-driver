...
/**
 * Attempts to configure the collection name as the lower case form of the class name.
 */
public class LowerCaseClassNamingConvention implements Convention {
    @Override
    public void apply(final ClassModel model) {
        model.setCollectionName(getWeight(), model.getType().getSimpleName().toLowerCase());
    }

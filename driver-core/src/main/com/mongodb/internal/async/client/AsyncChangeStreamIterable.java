...
public interface AsyncChangeStreamIterable<TResult> extends AsyncMongoIterable<ChangeStreamDocument<TResult>> {
     ...
     * @return this
     */
    AsyncChangeStreamIterable<TResult> resumeAfter(BsonDocument resumeToken);
     ...
     */
    AsyncChangeStreamIterable<TResult> batchSize(int batchSize);
     ...
     * @return this
     */
    AsyncChangeStreamIterable<TResult> maxAwaitTime(long maxAwaitTime, TimeUnit timeUnit);
     ...
     */
    <TDocument> AsyncMongoIterable<TDocument> withDocumentClass(Class<TDocument> clazz);
     ...
     */
    AsyncChangeStreamIterable<TResult> startAtOperationTime(BsonTimestamp startAtOperationTime);
     ...
     */
    AsyncChangeStreamIterable<TResult> startAfter(BsonDocument startAfter);
}

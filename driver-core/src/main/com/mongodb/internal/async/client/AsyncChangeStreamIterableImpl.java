...
final class AsyncChangeStreamIterableImpl<TResult> extends AsyncMongoIterableImpl<ChangeStreamDocument<TResult>>
        implements AsyncChangeStreamIterable<TResult> {
    ...
    AsyncChangeStreamIterableImpl(@Nullable final AsyncClientSession clientSession, final String databaseName,
    ...
    AsyncChangeStreamIterableImpl(@Nullable final AsyncClientSession clientSession, final MongoNamespace namespace,
                                  final CodecRegistry codecRegistry, final ReadPreference readPreference, final ReadConcern readConcern,
                                  final OperationExecutor executor, final List<? extends Bson> pipeline, final Class<TResult> resultClass,
                                  final ChangeStreamLevel changeStreamLevel, final boolean retryReads) {
    ...
    @Override
    public AsyncChangeStreamIterable<TResult> fullDocument(final FullDocument fullDocument) {
        this.fullDocument = notNull("fullDocument", fullDocument);
        return this;
    }

    @Override
    public AsyncChangeStreamIterable<TResult> resumeAfter(final BsonDocument resumeAfter) {
        this.resumeToken = notNull("resumeAfter", resumeAfter);
        return this;
    }

    @Override
    public AsyncChangeStreamIterable<TResult> batchSize(final int batchSize) {
        super.batchSize(batchSize);
        return this;
    }

    @Override
    public AsyncChangeStreamIterable<TResult> maxAwaitTime(final long maxAwaitTime, final TimeUnit timeUnit) {
    ...
    @Override
    public AsyncChangeStreamIterable<TResult> collation(@Nullable final Collation collation) {
        this.collation = notNull("collation", collation);
        return this;
    }

    @Override
    public <TDocument> AsyncMongoIterable<TDocument> withDocumentClass(final Class<TDocument> clazz) {
        return new AsyncMongoIterableImpl<TDocument>(getClientSession(), getExecutor(), getReadConcern(), getReadPreference(),
                getRetryReads()) {
    ...
    @Override
    public AsyncChangeStreamIterable<TResult> startAtOperationTime(final BsonTimestamp startAtOperationTime) {
        this.startAtOperationTime = notNull("startAtOperationTime", startAtOperationTime);
        return this;
    }

    @Override
    public AsyncChangeStreamIterableImpl<TResult> startAfter(final BsonDocument startAfter) {

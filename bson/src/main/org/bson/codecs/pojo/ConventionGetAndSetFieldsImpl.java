...
final class ConventionGetAndSetFieldsImpl implements Convention {
    ...
    public void apply(final ClassModelBuilder<?> classModelBuilder) {
        ...
        for (PropertyModelBuilder<?> propertyModelBuilder : classModelBuilder.getPropertyModelBuilders()) {
            if (!(propertyModelBuilder.getPropertyAccessor() instanceof PropertyAccessorImpl)) {
                throw new CodecConfigurationException(format("The GET_AND_SET_FIELDS_CONVENTION is not compatible with "

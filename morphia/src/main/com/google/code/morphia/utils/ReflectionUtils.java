...
public final class ReflectionUtils {
    ...
    /**
     * Get the class that parameterizes the Field supplied, at the index supplied (field can be parameterized with
     * multiple param classes).
     *
     * @param field the field
     ...
     * @return true if the field is parameterized and c is the class that parameterizes the field, or is an interface
     *         that the parameterized class implements, else false
     */

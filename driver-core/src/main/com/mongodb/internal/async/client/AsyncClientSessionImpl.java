...
class AsyncClientSessionImpl extends BaseClientSessionImpl implements AsyncClientSession {
    ...
    AsyncClientSessionImpl(final ServerSessionPool serverSessionPool, final AsyncMongoClient mongoClient,

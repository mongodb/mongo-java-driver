...
public class PropertyFieldAndGetModel {

    public String publicProperty;
    String protectedProperty;
    private String privateProperty;

    public PropertyFieldAndGetModel(){
    }

    public PropertyFieldAndGetModel(final String publicProperty, final String protectedProperty, final String privateProperty) {
    ...
    public boolean equals(final Object o) {
        ...
        final PropertyFieldAndGetModel that = (PropertyFieldAndGetModel) o;

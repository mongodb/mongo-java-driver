...
public abstract class AbstractServerDiscoveryAndMonitoringTest extends AbstractUnifiedTest {
    ...
    public static Collection<Object[]> data() throws URISyntaxException, IOException {
        ...
        for (File file : JsonPoweredTestHelper.getTestFiles("/server-discovery-and-monitoring-integration")) {

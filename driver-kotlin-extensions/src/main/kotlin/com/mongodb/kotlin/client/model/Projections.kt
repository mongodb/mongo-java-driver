 ...
 * This is used in an aggregation pipeline to reference a property from a path.
 */
public val <T> KProperty<T>.projection: String get() = path().projection

/**
 * The projection of the property.
 */
public val String.projection: String get() = "\$$this"
...
@JvmSynthetic
public infix fun <T0, T1> KProperty1<T0, T1?>.projectionWith(p2: String): String = "$projection.$p2"

/**
 * Creates a projection of a property whose value is computed from the given expression. Projection with an expression can be used in the
 * following contexts:
 * <ul>
...
/**
 * Creates a projection of a String whose value is computed from the given expression. Projection with an expression can be used in the
 * following contexts:
 * <ul>
 *   <li>$project aggregation pipeline stage.</li>
 *   <li>Starting from MongoDB 4.4, it's also accepted in various find-related methods within the
 ...
 */
public val <T> KProperty<T>.elemMatchProj: Bson get() = Projections.elemMatch(path())
...
/**
 * Creates a textScore projection for the given property, for use with text queries.
 * Calling this method is equivalent to calling {@link #meta(String)} with {@code "textScore"} as the argument.
 *
 * @return the projection
...
/**
 * Creates a searchScore projection for the given property,
 * for use with {@link Aggregates#search(SearchOperator, SearchOptions)} / {@link Aggregates#search(SearchCollector, SearchOptions)}.
 * Calling this method is equivalent to calling {@link #meta(String, String)} with {@code "searchScore"} as the argument.
 *
 * @return the projection
...
/**
 * Creates a vectorSearchScore projection for the given property,
 * for use with {@link Aggregates#vectorSearch(FieldSearchPath, Iterable, String, long, VectorSearchOptions)} .
 * Calling this method is equivalent to calling {@link #meta(String, String)} with {@code "vectorSearchScore"} as the argument.
 *
 * @return the projection
 * @mongodb.atlas.manual atlas-search/scoring/ Scoring
...
/**
 * Creates a searchHighlights projection for the given property,
 * for use with {@link Aggregates#search(SearchOperator, SearchOptions)} / {@link Aggregates#search(SearchCollector, SearchOptions)}.
 * Calling this method is equivalent to calling {@link #meta(String, String)} with {@code "searchHighlights"} as the argument.
 *
 * @return the projection

...
public interface AsyncAggregateIterable<TResult> extends AsyncMongoIterable<TResult> {
     ...
     */
    AsyncAggregateIterable<TResult> allowDiskUse(@Nullable Boolean allowDiskUse);
     ...
     */
    AsyncAggregateIterable<TResult> maxTime(long maxTime, TimeUnit timeUnit);
     ...
     * @since 3.6
     */
    AsyncAggregateIterable<TResult> maxAwaitTime(long maxAwaitTime, TimeUnit timeUnit);
     ...
     */
    AsyncAggregateIterable<TResult> batchSize(int batchSize);
     ...
     */
    AsyncAggregateIterable<TResult> bypassDocumentValidation(@Nullable Boolean bypassDocumentValidation);
     ...
     * @mongodb.server.release 3.6
     */
    AsyncAggregateIterable<TResult> comment(@Nullable String comment);
     ...
     * @mongodb.server.release 3.6
     */
    AsyncAggregateIterable<TResult> hint(@Nullable Bson hint);
}

...
class AsyncAsyncMongoClientsSpecification extends FunctionalSpecification {
    ...
    def 'should apply connection string to cluster settings'() {
        when:
        def client = AsyncMongoClients.create('mongodb://localhost,localhost:27018/') as AsyncMongoClientImpl
    ...
    def 'should apply connection string to credential list'() {
        when:
        def client = AsyncMongoClients.create('mongodb://u:p@localhost/') as AsyncMongoClientImpl
    ...
    def 'should apply connection string to server settings'() {
        when:
        def client = AsyncMongoClients.create('mongodb://localhost/?heartbeatFrequencyMS=50') as AsyncMongoClientImpl
    ...
    def 'should apply connection string to connection pool settings'() {
        when:
        def client = AsyncMongoClients.create('mongodb://localhost/?maxIdleTimeMS=200&maxLifeTimeMS=300') as AsyncMongoClientImpl
    ...
    def 'should apply connection string to ssl settings'() {
        when:
        def client = AsyncMongoClients.create('mongodb://localhost/?ssl=true&sslInvalidHostNameAllowed=true') as AsyncMongoClientImpl
    ...
    def 'should apply connection string to socket settings'() {
        when:
        def client = AsyncMongoClients.create('mongodb://localhost/?connectTimeoutMS=300') as AsyncMongoClientImpl
    ...
    def 'should apply read preference from connection string to settings'() {
        when:
        def client = AsyncMongoClients.create(uri) as AsyncMongoClientImpl

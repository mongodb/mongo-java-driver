...
/**
 * Represents a <a href="http://www.mongodb.org/display/DOCS/Connections">URI</a> which can be used to create a Mongo
 * instance. The URI describes the hosts to be used and options. <p> This class has been superseded by <{@code
 * MongoClientURI}, and may be deprecated in a future release. <p>The format of the URI is:
 * <pre>
...
public class MongoURI {
     ...
     *
     * @return a new Mongo instance.  There is no caching, so each call will create a new instance, each of which must
     *         be closed manually.
     ...
     *
     * @return the database specified in the URI.  This will implicitly create a new Mongo instance, which must be
     *         closed manually.
     * @throws MongoException
     * @throws UnknownHostException
     */

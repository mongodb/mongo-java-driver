...
import com.mongodb.client.model.search.{ VectorSearchScoreMode => JVectorSearchScoreMode }
...
object VectorSearchScoreMode {
   ...
   */
  val AVG: JVectorSearchScoreMode = JVectorSearchScoreMode.AVG

  /**
   * Use the maximum of the scores of the matching embeddings within a document.
   */
  val MAX: JVectorSearchScoreMode = JVectorSearchScoreMode.MAX
}

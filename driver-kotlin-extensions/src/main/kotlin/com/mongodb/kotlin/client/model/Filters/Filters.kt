 ...
 * @return the filter
 */
@JvmName("lteExt") public infix fun <@OnlyInputTypes T> KProperty<T?>.lte(value: T): Bson = Filters.lte(path(), value)
 ...
 * @return the filter
 */
@JvmName("gteExt") public infix fun <@OnlyInputTypes T> KProperty<T>.gte(value: T): Bson = Filters.gte(path(), value)
...
/**
 * Creates a filter that matches all documents where the value of a property equals any value in the list of specified
 * values.
 *
...
/**
 * Creates a filter that matches all documents where the value of a property does not equal any of the specified values
 * or does not exist.
 *
 * @param values the list of values
 * @param <T> the value type
 ...
 */
@JvmName("ninIterable")
public fun <@OnlyInputTypes T> nin(property: KProperty<Iterable<T>?>, values: Iterable<T?>): Bson = property.nin(values)

/**
 * Creates a filter that performs a logical AND of the provided list of filters. Note that this will only generate an
 * "$and" operator if absolutely necessary, as the query language implicitly ands together all the keys. In other words,
...
/**
 * Creates a filter that matches all documents that do not match the passed in filter. Requires the property to passed
 * as part of the value passed in and lifts it to create a valid "$not" query:
 * ```not(eq("x", 1))```
 *
...
/**
 * Creates a filter that matches all documents that either contain or do not contain the given property, depending on
 * the value of the exists parameter.
 *
 * @param exists true to check for existence, false to check for absence
 * @return the filter
 */
@JvmName("existsExt") public infix fun <T> KProperty<T?>.exists(exists: Boolean): Bson = Filters.exists(path(), exists)
 ...
 * @return the filter
 */
@JvmName("regexExt") public infix fun KProperty<String?>.regex(pattern: String): Bson = Filters.regex(path(), pattern)
 ...
 * @return the filter
 */
@JvmName("regexExt") public infix fun KProperty<String?>.regex(pattern: Pattern): Bson = Filters.regex(path(), pattern)
 ...
 */
@JvmName("regexExt")
public fun KProperty<String?>.regex(pattern: String, options: String): Bson = Filters.regex(path(), pattern, options)
...
/**
 * Creates a filter that matches all documents where the value of a property is an array that contains all the specified
 * values.
 *
 * @param values the list of values
 * @param <T> the value type
 ...
 * @return the filter
 */
public fun <@OnlyInputTypes T> all(property: KProperty<Iterable<T>?>, values: Iterable<T>): Bson = property.all(values)
 ...
 * @return the filter
 */
public fun <@OnlyInputTypes T> all(property: KProperty<Iterable<T>?>, vararg values: T): Bson = property.all(*values)

/**
 * Creates a filter that matches all documents containing a property that is an array where at least one member of the
 * array matches the given filter.
 *
...
/**
 * Creates a filter that matches all documents containing a property with geospatial data that exists entirely within
 * the specified shape.
 *
...
/**
 * Creates a filter that matches all documents containing a property with geospatial data (GeoJSON or legacy coordinate
 * pairs) that exist entirely within the specified circle, using spherical geometry. If using longitude and latitude,

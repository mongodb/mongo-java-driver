...
class AsyncGridFSFindIterableSpecification extends Specification {
    ...
    def 'should build the expected findOperation'() {
        ...
        def underlying = new AsyncFindIterableImpl(null, namespace, GridFSFile, GridFSFile, codecRegistry, readPreference,
                readConcern, executor,
                new Document(), true)
        def findIterable = new AsyncGridFSFindIterableImpl(underlying)
    ...
    def 'should handle mixed types'() {
        ...
        def findIterable = new AsyncFindIterableImpl(null, namespace, GridFSFile, GridFSFile, codecRegistry, readPreference,
                readConcern, executor, new Document('filter', 1), true)
    ...
    def 'should follow the MongoIterable interface as expected'() {
        ...
        def underlying = new AsyncFindIterableImpl(null, namespace, GridFSFile, GridFSFile, codecRegistry, readPreference,
                readConcern, executor, new Document(), true)
        def mongoIterable = new AsyncGridFSFindIterableImpl(underlying)

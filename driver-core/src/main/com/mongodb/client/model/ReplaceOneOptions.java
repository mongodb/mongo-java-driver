...
/**
 * The options for replacing at most one document that matches the query criteria.
 *
 * @since 3.0
 * @mongodb.driver.manual manual/tutorial/modify-documents/#replace-the-document Replace
 */
public final class ReplaceOneOptions {
     ...
     * @return this
     */
    public ReplaceOneOptions upsert(final boolean upsert) {
        this.upsert = upsert;
        return this;
    }
}

...
public class QueryBuilder implements ConvertibleToDocument {
    ...
    public QueryBuilder geoIntersects(final GeoJsonObject geoJsonObject) {
        ...
        if (t.equals(GeoJsonObject.POLYGON) || t.equals(GeoJsonObject.POINT) || t.equals(GeoJsonObject.LINE_STRING)) {
            addOperand(QueryOperators.GEO_INTERSECTS,
                    new Document(QueryOperators.GEOMETRY, geoJsonObject));
        } else {
            throw new QueryBuilderException("The geoIntersects operand accept point, "
                                            + "line or polygon, and you have sent a " + t);
        }
        return this;
    }

...
public class DBEncoderDecoderSerializer implements Serializer<DBObject> {
    ...
    public DBEncoderDecoderSerializer(final DBEncoder encoder, final DBDecoder decoder,
    ...
    @Override
    public void serialize(final BSONWriter bsonWriter, final DBObject value) {

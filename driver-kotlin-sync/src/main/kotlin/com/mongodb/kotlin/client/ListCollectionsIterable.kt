...
public class ListCollectionsIterable<T : Any>(private val wrapped: JListCollectionsIterable<T>) :
     ...
     * [ListCollectionsIterable] obtained not via any of the [MongoDatabase.listCollectionNames] methods.
     *
     ...
     * @since 5.0
     */
    public fun authorizedCollections(authorizedCollections: Boolean): ListCollectionsIterable<T> = apply {

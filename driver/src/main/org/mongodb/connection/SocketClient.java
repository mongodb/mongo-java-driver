...
class SocketClient {
    ...
    public void read(final ByteBuffer byteBuf, final CompletionHandler<Void, Void> callback) {
        try {
            boolean offer = waitingReads.offer(new AsyncCompletionHandler() {
                @Override
                public void completed() {
                    try {
                        readToBuffer(byteBuf);
    ...
    public void write(final List<ByteBuf> byteBuffers, final CompletionHandler<Void, Void> handler) {

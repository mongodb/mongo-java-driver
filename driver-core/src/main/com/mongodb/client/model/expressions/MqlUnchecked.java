...
public @interface MqlUnchecked {
    ...
    enum Unchecked {
        ...
        TYPE_ARGUMENT,
        /**
         * The API relies on the element identified by index, name, position, etc., being present in the
         * {@linkplain com.mongodb.client.model.expressions.DocumentExpression document},
         * {@linkplain com.mongodb.client.model.expressions.MapExpression map},
         * {@linkplain com.mongodb.client.model.expressions.ArrayExpression array} involved.

...
public final class UpdateOneModel<T> extends WriteModel<T> {
     ...
     * @param options the options to apply
     */
    public UpdateOneModel(final Bson filter, final Collation collation, final Bson update, final UpdateOptions options) {
        this(filter, null, update, options, true);
    }

    private UpdateOneModel(final Bson filter, final Collation collation, final Bson update, final UpdateOptions options,

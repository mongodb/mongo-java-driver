...
public class DefaultCreator implements ObjectFactory {
    ...
    /* (non-Javadoc)
     * @see com.google.code.morphia.ObjectFactory#createInstance(com.google.code.morphia.mapping.Mapper,
     * com.google.code.morphia.mapping.MappedField, com.mongodb.DBObject)
     */
    public Object createInstance(final Mapper mapr, final MappedField mf, final DBObject dbObj) {
        ...
        try {
            ...
            try {
                final Constructor ctor = c.getDeclaredConstructor(argTypes);
